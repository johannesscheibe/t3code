...
describe("buildTurnStartParams", () => {
  ...
  it.effect("grants attached worktrees as writable roots on workspace-write turns", () =>
    Effect.gen(function* () {
      ...
      NodeAssert.deepStrictEqual(params.sandboxPolicy.writableRoots, ["/worktrees/lib"]);
    }),
  );
